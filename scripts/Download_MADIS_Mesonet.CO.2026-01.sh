...
########################################################################
# Download MADIS Mesonet surface observation data files from the MADIS
...
# Download the requested MADIS Mesonet surface data.
build-mesonet-dataset --remove-original -n 16 ${START_YEAR} ${START_MONTH} ${START_DAY} ${END_YEAR} ${END_MONTH} ${END_DAY} ${REGION} ${OUT_DIR}
