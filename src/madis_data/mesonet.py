...
def mesonet_local_file_paths(data_dir: Path, urls: list[str]) -> list[Path]:
    ...
    return local_file_paths(data_dir, urls, 'mesonet')
...
MESONET_DATA_SOURCE = StationDataSource(
    name='Mesonet',
    file_prefix='mesonet',
    urls=mesonet_urls,
    variables=mesonet_variables,
    extract_file=extract_mesonet_data_single,
)
